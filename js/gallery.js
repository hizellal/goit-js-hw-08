...
gallery.addEventListener("click", (event) => {
    ...
    const imageCardEl = event.target.closest('.gallery-image');

    console.dir(imageCardEl);

    const imageDescr = imageCardEl.dataset.source;

    console.log(imageDescr);

    const imageInfo = images.find((el) => el.original === imageDescr);
